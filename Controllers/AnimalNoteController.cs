...
public class AnimalNoteController : ControllerBase
{
    ...
    public async Task<IActionResult> OnPostAsync(
        [FromBody] CreateAnimalNoteRequest request,
    ...
    public async Task<IActionResult> OnPutAsync(
        int id, [FromBody] AnimalNoteModel updatedAnimalNoteModel, [FromServices] Client client)
    {
...
public class CreateAnimalNoteRequest
{
}